...
builtin/builtin_cd.c builtin/builtin_echo.c builtin/builtin_pwd.c builtin/builtin_env.c builtin/builtin_exit.c  \
#    builtin/builtin_unset.c builtin/builtin_export.c
OUT = $(SRC:.c=.o)
