...
panic/panic_bt.c \
utils/builtin_utils.c utils/freeable.c utils/ft_atoi.c utils/ft_itoa.c utils/ft_split.c utils/ft_strjoin.c utils/ft_substr.c utils/input_utils.c utils/utils_bt.c utils/utils_get_args.c utils/utils.c utils/utils2.c \
